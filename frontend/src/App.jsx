...
//         {/* Sidebar */}
//         <div style={{
//           width: sidebarOpen ? 220 : 60, background: '#0f172a',
...
//           }}>
//             <div style={{
//               width: 32, height: 32, background: 'linear-gradient(135deg, #6366f1, #a855f7)',
...
//             {sidebarOpen && (
//               <div>
//                 <div style={{ color: '#e2e8f0', fontWeight: 800, fontSize: 14, lineHeight: 1 }}>AliceTrade</div>
//                 <div style={{ color: '#6366f1', fontSize: 10, fontWeight: 600 }}>MULTI-CLIENT</div>
//               </div>
//             )}
...
//               <button key={id} onClick={() => setActiveView(id)} style={navStyle(activeView === id)}>
//                 <Icon size={16} />
//                 {sidebarOpen && label}
//               </button>
//             ))}
...
//             {sidebarOpen && <span style={{ color: '#22c55e', fontSize: 11, fontWeight: 600 }}>Markets Active</span>}
//           </div>
//         </div>
...
//             display: 'flex', flexDirection: 'column', background: '#0f172a', flexShrink: 0
//           }}>
//             {/* Market Watch - top 60% */}
...
//             {/* Order Panel - bottom 40% */}
//             <div style={{ flex: 5, minHeight: 0, borderTop: '1px solid #1e293b', overflow: 'hidden' }}>
