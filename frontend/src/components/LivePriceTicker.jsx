...
//           <span style={{ color: isUp ? '#166534' : '#7f1d1d',
...
//       color: tab===id ? 'white' : '#64748b', fontSize:10, fontWeight:600, cursor:'pointer'
//     }}>{lbl}</button>
//   );
...
//           <span style={{ color:'#94a3b8', fontWeight:700, fontSize:11, textTransform:'uppercase' }}>
//             Market Watch
//           </span>
...
//         {/* Source badge */}
//         <div style={{ fontSize:9, color:'#475569', marginBottom:5, display:'flex', alignItems:'center', gap:4 }}>
...
//             <Search size={11} color="#64748b" style={{ position:'absolute', left:7, top:'50%', transform:'translateY(-50%)' }}/>
//             <input autoFocus value={searchQ} onChange={e => setSearchQ(e.target.value)}
//               placeholder="Search NSE / BSE / F&O…"
//               style={{
//                 width:'100%', boxSizing:'border-box',
//                 background:'#1e293b', border:'1px solid #334155', borderRadius:5,
//                 padding:'6px 6px 6px 24px', color:'#e2e8f0', fontSize:12, outline:'none'
//               }}/>
//             {searchQ && (
...
//                     padding:'7px 10px', borderBottom:'1px solid #080e1a', cursor:'pointer' }}>
//                     <div style={{ flex:1 }}
...
//         {tab === 'search' && (
//           searching
//             ? <div style={{ color:'#64748b', textAlign:'center', padding:20, fontSize:12 }}>Searching…</div>
//             : searchQ.length < 2
...
//                     padding:'8px 10px', borderBottom:'1px solid #080e1a' }}>
...
//                     </div>
//                     {lp?.ltp > 0 && (
//                       <div style={{ textAlign:'right', marginRight:5, cursor:'pointer' }}
//                         onClick={() => onSelectSymbol?.(inst.symbol, inst.exchange)}>
//                         <div style={{ fontSize:12, fontWeight:700, fontFamily:'monospace',
//                                       color: isUp?'#22c55e':'#ef4444' }}>
//                           ₹{lp.ltp?.toFixed(2)}
...
//       {/* Footer */}
//       <div style={{ padding:'4px 10px', borderTop:'1px solid #1e293b', flexShrink:0,
//                     display:'flex', justifyContent:'space-between', alignItems:'center',
//                     fontSize:9, color:'#334155' }}>
//         <span>{liveList.length} live</span>
